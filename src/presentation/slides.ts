...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    flow: [
      ...
      { icon: 'FileSearch', title: 'СТАНЕТ:', lines: ['Код проверен во всех сервисах,', 'слабые места устранены'] },
    ...
    impacts: [
      ...
      { icon: 'ShieldCheck', label: 'Устаревшие и небезопасные решения устранены' },
    ],
    kpiTitle: 'Что изменится к концу года',
    kpis: [
  ...
  },
  {
    ...
    impacts: [
      ...
      { icon: 'ClipboardCheck', label: 'Статус и сроки всех проектов видны руководству' },
    ],
    kpiTitle: 'Что изменится к концу года',
    kpis: [
      ...
      { icon: 'ClipboardCheck', label: 'Проекты по стандарту', value: '100', note: '%', progress: 100 },
    ],
  },
];