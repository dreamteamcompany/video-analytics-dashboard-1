...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    badgeIcon: 'Code',
    columnsLabel: 'группы',
    head: { role: 'Руководитель Службы', name: 'Требуется поиск', salary: '**** ₽/мес', vacancy: true, duties: ['Приём и реализация ТЗ от Службы проектного управления', 'Плотное взаимодействие с проектным офисом на всех этапах проекта', 'Оценка сроков и ресурсов по каждому ТЗ, защита реалистичных планов', 'Единая техническая стратегия и архитектура цифровых решений', 'Управление разработкой веб-сервисов: от задачи до релиза', 'Развитие ИИ-направления и внедрение прикладных ИИ-решений', 'Контроль качества: code review, тестирование, стабильность релизов', 'Единое хранилище кода, стандарты разработки и документация', 'Каталог сервисов, владельцы и SLA по поддержке', 'Развитие BI-аналитики: данные и дашборды для решений руководства', 'Безопасность в разработке совместно со Службой ИБ', 'Управление подрядчиками и контроль бюджета на разработку', 'Планирование загрузки команды и снижение зависимости от ключевых людей', 'Развитие команды: подбор, наставничество, рост компетенций'] },
    payroll: '**** ₽/мес',
    payrollNote: 'с учётом открытых вакансий',
    columns: [
      {
