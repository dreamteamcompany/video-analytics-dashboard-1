...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    head: { role: 'Руководитель Службы', name: 'Гаврилова Е.И.', salary: '180 000 ₽/мес', photo: 'https://cdn.poehali.dev/projects/bb37ddcd-e150-4859-a38d-a9aea67934e1/bucket/851dcb31-49db-40a3-b9f6-a38c0d433684.png', duties: ['Стратегия информационной безопасности сети клиник', 'Защита персональных и медицинских данных пациентов', 'Соответствие 152-ФЗ и требованиям регуляторов, снижение рисков штрафов', 'Управление рисками ИБ и приоритеты защитных мер', 'Бюджет ИБ: выбор решений и подрядчиков, контроль затрат', 'Управление командой ИБ: инженерия и аналитика', 'Контроль инцидентов и готовность к кибератакам', 'Защита от утечек данных и внутренних угроз', 'Требования по ИБ к ИТ-проектам и подрядчикам', 'Отчётность по уровню защищённости для собственников'] },
    payroll: '450 000 ₽/мес',
    payrollNote: 'с учётом открытых вакансий',
    columns: [
      {
