    ...
    columns: [
      {
        ...
        people: [
          ...
          { role: 'Специалист 1-й линии', name: 'Анфёрова В.С.', salary: '70 000 ₽/мес', photo: 'https://cdn.poehali.dev/projects/bb37ddcd-e150-4859-a38d-a9aea67934e1/bucket/c9b77f81-777c-4a94-b4d0-54aed1d8a113.png', duties: ['Приём и регистрация обращений от клиник', 'Решение типовых вопросов: доступы, печать, ПО', 'Передача сложных заявок на 2-ю линию и контроль срока', 'Ведение базы решений и инструкций для сотрудников'] },
