    ...
    goals: [
      {
        ...
        icon: 'BrainCircuit',
        metric: '−50%',
        metricNote: 'инцидентов за счёт предиктивной профилактики',
        text: 'ML прогнозирует отказы за 2–4 часа и сам запускает профилактику.',
        effect: 'меньше простоев, выше стабильность.',
      },
      {
        title: 'Поддержка в бизнес-метриках',
        icon: 'ChartNoAxesCombined',
        metric: 'IT → ₽',
        metricNote: 'связь IT с финансами через понятные метрики',
      ...
      },
      {
        ...
        icon: 'Settings',
        metric: '50%',
        metricNote: 'типовых операций — без участия инженера',
        text: 'Автоматизация маршрутизации, согласований, выдачи доступов и стандартных операций.',
        effect: 'меньше ручного труда, быстрее обслуживание.',
      },
      {
        title: 'Снижение стоимости поддержки',
        icon: 'Wallet',
        metric: '−25%',
        metricNote: 'стоимость обработки одной заявки',
        text: 'AI + автоматизация + самообслуживание позволяют масштабировать поддержку без пропорционального роста штата.',
        effect: 'экономия бюджета при росте объёма услуг.',
      },
      {
        title: 'Предотвращение критических инцидентов',
        icon: 'ShieldCheck',
        metric: '−50%',
        metricNote: 'критических инцидентов',
        text: 'Переход от устранения последствий к прогнозированию и предотвращению сбоев.',
        effect: 'меньше простоев, меньше финансовых потерь.',
      },
      {
        title: 'IT → бизнес-результат',
        icon: 'ChartPie',
        metric: '100%',
        metricNote: 'ключевых сервисов — с измеримым бизнес-эффектом',
        text: 'Для каждого критичного сервиса — измеримый бизнес-эффект и стоимость.',
        effect: 'IT становится прозрачным и управляется через деньги и результат.',
      },
      {
        title: 'Предиктивная поддержка',
        icon: 'Radar',
        metric: '70%',
        metricNote: 'потенциальных сбоев выявляются до обращения пользователя',
        text: 'AIOps выявляет аномалии и предупреждает проблему до того, как она станет инцидентом.',
        effect: 'поддержка не реагирует на проблемы — она не даёт им произойти.',
      },
      {
