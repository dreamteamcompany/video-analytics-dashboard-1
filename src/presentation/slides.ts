...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    goals: [
      ...
      {
        title: 'Снижение зависимости от подрядчика',
        icon: 'Handshake',
        metric: '↓',
        metricNote: 'передача экспертизы внутрь',
        text: 'Стандартизация и документирование инфраструктуры: работа не завязана на конкретных людей подрядчика, компетенции переходят внутрь компании.',
        effect: 'смена подрядчика перестаёт быть риском для бизнеса.',
      },
    ],
    flow: [
      { icon: 'Search', title: 'СЕЙЧАС:', lines: ['Сервисы на отдельных серверах,', 'обновления вручную'] },
      { icon: 'Boxes', title: 'СТАНЕТ:', lines: ['Единая платформа Kubernetes', 'с автоматикой и мониторингом'] },
      { icon: 'Gem', title: 'РЕЗУЛЬТАТ ДЛЯ БИЗНЕСА:', lines: ['Сервисы работают без остановок,', 'обновления — за минуты'] },
    ],
    impactGoal: 'Современная платформа вместо ручного администрирования',
    impacts: [
      ...
      { icon: 'Handshake', label: 'Компания меньше зависит от внешнего подрядчика' },
    ],
    kpiTitle: 'Что изменится к концу года',
    kpis: [
      ...
      { icon: 'GitBranch', label: 'Время выкладки', value: 'мин', note: 'вместо часов', progress: 85 },
