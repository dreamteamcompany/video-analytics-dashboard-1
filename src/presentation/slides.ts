...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    badgeIcon: 'ShieldCheck',
    title: 'Планы до конца 2026 года',
    subtitle: 'Закрываем базовые риски: видим, кто и к чему имеет доступ, и готовы отразить атаку.',
    goalsYear: '2026',
    goals: [
      {
        title: 'Аудит доступов и учётных записей',
        icon: 'KeyRound',
        metric: '100%',
        metricNote: 'сотрудников с проверенными правами',
        text: 'Полная инвентаризация: у кого какие права в системах, отзыв доступов уволенных, устранение «лишних» администраторов и общих паролей.',
        effect: 'к данным пациентов и финансам имеют доступ только те, кому положено.',
      },
      {
        title: 'Защита от вирусов и шифровальщиков',
        icon: 'ShieldAlert',
        metric: '100%',
        metricNote: 'рабочих мест под защитой',
        text: 'Единая антивирусная защита на всех рабочих станциях и серверах с централизованным контролем и обновлениями.',
        effect: 'клиника не встанет из-за одного заражённого компьютера.',
      },
      {
        title: 'Резервное копирование и проверка восстановления',
        icon: 'DatabaseBackup',
        metric: '24',
        metricNote: 'часа — максимальная потеря данных',
        text: 'Регулярные копии критичных систем с хранением отдельно от основной сети и обязательными тестами восстановления.',
        effect: 'даже при аварии или атаке данные восстанавливаются, а не теряются.',
      },
      {
        title: 'Обучение сотрудников и защита от фишинга',
        icon: 'GraduationCap',
        metric: '100%',
        metricNote: 'сотрудников прошли обучение',
        text: 'Короткие тренинги по кибергигиене и учебные фишинговые рассылки с разбором ошибок.',
        effect: 'сотрудник не откроет опасное письмо — самый частый вход атаки закрыт.',
      },
      {
        title: 'Контроль защищённости и уязвимостей',
        icon: 'Radar',
        metric: 'ежемес.',
        metricNote: 'проверка внешнего периметра',
        text: 'Регулярное сканирование сервисов, доступных из интернета, и приоритетное закрытие критичных уязвимостей.',
        effect: 'дыры находим мы, а не злоумышленники.',
      },
      {
        title: 'Регламенты ИБ и защита персональных данных',
        icon: 'FileCheck',
        metric: '152-ФЗ',
        metricNote: 'требования закрыты документально',
        text: 'Политики ИБ, порядок реагирования на инциденты и приведение обработки персональных данных к требованиям закона.',
        effect: 'меньше риск проверок и штрафов, порядок вместо ручного тушения.',
      },
    ],
    flow: [
      { icon: 'Search', title: 'СЕЙЧАС:', lines: ['Риски не измерены,', 'защита держится на людях'] },
      { icon: 'ShieldCheck', title: 'СТАНЕТ:', lines: ['Контроль доступов, защита,', 'копии и обученные сотрудники'] },
      { icon: 'Gem', title: 'РЕЗУЛЬТАТ ДЛЯ БИЗНЕСА:', lines: ['Клиника работает без остановок,', 'данные пациентов защищены'] },
    ],
    impactGoal: 'Безопасность — это непрерывность работы клиники',
    impacts: [
      { icon: 'KeyRound', label: 'Доступ к данным только у тех, кому он нужен' },
      { icon: 'ShieldAlert', label: 'Атака шифровальщика не останавливает приём пациентов' },
      { icon: 'DatabaseBackup', label: 'Данные восстанавливаются даже в худшем сценарии' },
      { icon: 'FileCheck', label: 'Требования по персональным данным закрыты' },
    ],
    kpiTitle: 'Что изменится к концу года',
    kpis: [
      { icon: 'KeyRound', label: 'Проверено доступов', value: '100', note: '%', progress: 100 },
      { icon: 'ShieldAlert', label: 'Защита рабочих мест', value: '100', note: '%', progress: 100 },
      { icon: 'DatabaseBackup', label: 'Копии критичных систем', value: '24', note: 'часа', progress: 90 },
      { icon: 'GraduationCap', label: 'Обучены сотрудники', value: '100', note: '%', progress: 100 },
      { icon: 'Radar', label: 'Скан периметра', value: '1', note: 'раз/мес', progress: 85 },
      { icon: 'Timer', label: 'Реакция на инцидент ИБ', value: '15', note: 'мин', progress: 90 },
    ],
  },
  {
    id: 'infra',
